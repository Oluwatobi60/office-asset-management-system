...
<body>
   ...
   <!--  <div class="preloader">
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <!-- ============================================================== -->
                    <!-- Logo -->
                    <!-- ============================================================== -->                    <a class="navbar-brand" href="../../userfolder/dashboard.php">
                        <!-- Logo icon -->
                   ...
                   <div class="row bg-light rounded"><!-- start row-->                    
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            ...
                            <input type="text" id="reg_no" class="form-control" value="<?php echo htmlspecialchars($row['reg_no']); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            ...
                            <input type="text" id="asset_name" class="form-control" name="asset_name" value="<?php echo htmlspecialchars($row['asset_name']); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            ...
                            <textarea name="desc" id="description" rows="3" class="form-control" disabled><?php echo htmlspecialchars($row['description']); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            ...
                            <input type="number" id="quantity" class="form-control" name="qty" value="<?php echo htmlspecialchars($row['quantity']); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="request_date" class="form-label">Allocated Date:</label>
                            <input type="text" id="request_date" class="form-control" name="date_added" value="<?php echo htmlspecialchars($row['request_date']); ?>" disabled>
                        </div>
                    </div>                    <div class="col-md-8">
                        <a href="../../userfolder/allocation.php"><button class="btn btn-primary"><i class='fa fa-backward'></i></button></a>
                    </div>
    ...
    <!-- <script src="dist/js/pages/dashboards/dashboard1.js"></script> -->    <!-- Charts js Files -->
