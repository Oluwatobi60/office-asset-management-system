    ...
    try {
        ...
        try {
            ...
            $insertSql = "INSERT INTO borrow_table (reg_no, asset_name, purpose, quantity, category, employee_name, department, borrow_date, borrow_by) 
                         VALUES (:reg_no, :asset_name, :purpose, :quantity, :category, :employee_name, :department, :borrow_date, :borrow_by)";
            ...
            $stmt->bindValue(':employee_name', $assignedEmployee, PDO::PARAM_STR);
            $stmt->bindValue(':department', $department, PDO::PARAM_STR);
            $stmt->bindValue(':borrow_date', $date, PDO::PARAM_STR);
            $stmt->bindValue(':borrow_by', $requestedBy, PDO::PARAM_STR);
