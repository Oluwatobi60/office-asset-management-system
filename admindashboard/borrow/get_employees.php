...
try {
    ...
    error_log("Fetching employees for department: " . $department);
      // Query the user_table for employees in the selected department
    ...
    $stmt->bindParam(':department', $department, PDO::PARAM_STR);    if (!$stmt->execute()) {
    ...
    $employees = [];    foreach ($results as $row) {
