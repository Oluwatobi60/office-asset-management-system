...
try {
    ...
    if (isset($_POST['submit'])) {
        ...
        // Check if new category name already exists for other categories
        $check_sql = "SELECT COUNT(*) FROM category WHERE category = :category AND id != :id";
        ...
        // Update the category
        $update_sql = "UPDATE category SET category = :category WHERE id = :id";
        $stmt = $conn->prepare($update_sql);
        $stmt->bindParam(':category', $category);
        $stmt->bindParam(':id', $id, PDO::PARAM_INT);
        
        if ($stmt->execute()) {
            logError("Category updated successfully (ID: $id, New name: $category)");
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->                <?php
                    ...
                    if (!$row) {
                        logError("Category not found: ID $id");
                 ...
                 <div class="row bg-light rounded"><!-- start row-->
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="category" class="col-form-label">Category:</label>                            <input type="text" class="form-control" placeholder="Enter Category" name="category" id="category" value="<?php echo htmlspecialchars($row['category']); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-8 m-auto">
                ...
                <?php
                    ...
                    logError("Error in editcategory.php: " . $e->getMessage());
