                ...
                <div>
                    <div class="text-center p-t-20 p-b-20">
                       <!--  <span class="db"><img src="assets/images/logo.png" alt="logo" /></span> -->
                         <h1 style="font-family:'Courier New', Courier, monospace; color:#fff">Add User</h1>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" action="#">
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-danger text-white" id="basic-addon1"><i class="ti-id-badge"></i></span>
                                    </div>
                                    <input type="text" class="form-control form-control-lg" placeholder="Role/Priviledge" aria-label="Username" aria-describedby="basic-addon1" required>
                                </div>
