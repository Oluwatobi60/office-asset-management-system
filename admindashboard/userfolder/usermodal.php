                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select id="role" class="form-control" name="role">
                                                    ...
                                                    <?php                                                    // Fetch roles from the database and populate the dropdown
                                                    $sql = "SELECT * FROM role";
                                                    $stmt = $conn->prepare($sql);
                                                    $stmt->execute();
                                                    if ($stmt->rowCount() > 0) {
                                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                            echo "<option value='".htmlspecialchars($row['user_role'])."'>".htmlspecialchars($row['user_role'])."</option>";
                                                        }
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select id="department" class="form-control" name="department">
                                                    ...
                                                    <?php                                                    // Fetch departments from the database and populate the dropdown
