                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group">
                            <label for="" class="form-label">First Name:</label>
                                <input type="text" id="" class="form-control" name="firstname" value="<?php echo $row['firstname']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group">
                            <label for="" class="form-label">Last Name:</label>
                                <input type="text" id="" class="form-control" name="lastname" value="<?php echo $row['lastname']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group">
                            <label for="" class="form-label">Username:</label>
                                <input type="email" id="" class="form-control" name="username" value="<?php echo $row['username']; ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group">
                            <label for="" class="form-label">Email:</label>
                                <input type="email" id="" class="form-control" name="email" value="<?php echo $row['email']; ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group">
                            <label for="" class="form-label">Phone:</label>
                                <input type="number" id="" class="form-control" name="phone" value="<?php echo $row['phone']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group">
                            <label for="" class="form-label">Department:</label>
                                <input type="text" id="department" class="form-control" name="department" value="<?php echo $row['department']; ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group">
                            <label for="" class="form-label">Change password:</label>
                                <input type="password" id="department" class="form-control" name="password" value="<?php echo $row['password']; ?>">
                        </div>
                    </div>
