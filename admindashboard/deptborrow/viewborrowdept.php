             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center mt-3">
                        <h4 class="page-title">View Borrowed Department</h4>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->                <?php
                    ...
                    try {
                        ...
                        $sql = "SELECT * FROM department_borrow_table WHERE id = :id";
                        ...
                        error_log("Error in viewborrowdept.php: " . $e->getMessage());
                        echo '<div class="alert alert-danger">An error occurred while fetching the record</div>';
                        exit();
                    }
                ?>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="" class="form-label">Registration No:</label>
                                <input type="text" id="" class="form-control"  value="<?php echo htmlspecialchars($row['reg_no']); ?>"  disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="" class="form-label">Asset Name:</label>
                                <input type="text" id="" class="form-control" name="asset_name" value="<?php echo htmlspecialchars($row['asset_name']); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="" class="form-label">Purpose:</label>
                                <textarea name="desc" id="" rows="3" class="form-control" disabled><?php echo htmlspecialchars($row['purpose']); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="" class="form-label">Quantity:</label>
                                <input type="number" id="" class="form-control" name="qty" value="<?php echo htmlspecialchars($row['quantity']); ?>" disabled>
                        </div>
                    </div>

                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="category" class="col-form-label">Borrowed Employee:</label>
                                <input type="text" id="category" class="form-control"  value="<?php echo htmlspecialchars($row['employee_name']); ?>" disabled>
                        </div>
                    </div>

                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="category" class="col-form-label">From Department:</label>
                                <input type="text" id="department" class="form-control"  value="<?php echo htmlspecialchars($row['department']); ?>" disabled>
                        </div>
                    </div>

                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="category" class="col-form-label">Borrowed Department:</label>
                                <input type="text" id="category" class="form-control" name="asset_cat" value="<?php echo htmlspecialchars($row['borrow_by_dept']); ?>" disabled>
                        </div>
                    </div>

                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="" class="form-label">Date Borrowed:</label>
                                <input type="text" id="" class="form-control" name="date_added" value="<?php echo htmlspecialchars($row['borrow_date']); ?>" disabled>
                        </div>
                    </div>

                    <div class="col-md-8">
                        <a href="../borrowdept.php"><button class="btn btn-primary"><i class='fa fa-backward'></i></button></a>
                    </div>
