            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->                <?php
                    ...
                    try {
                        ...
                        error_log("Error in viewrequest.php: " . $e->getMessage());
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="" class="form-label">Description:</label>
                                <textarea name="desc" id="" rows="3" class="form-control" disabled><?php echo htmlspecialchars($row['description']); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="category" class="col-form-label">Requested by:</label>
                                <input type="text" id="category" class="form-control" name="asset_cat" value="<?php echo htmlspecialchars($row['assigned_employee']); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="" class="form-label">Date Added:</label>
                                <input type="text" id="" class="form-control" name="date_added" value="<?php echo htmlspecialchars($row['request_date']); ?>" disabled>
                        </div>
                    </div>
