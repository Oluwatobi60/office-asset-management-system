                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="../index.php">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->                            <img src="../../admindashboard/assets/images/logo.png" alt="homepage" class="light-logo" width="100px"/>
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->                <?php
                    try {
                        ...
                        $sql = "SELECT * FROM borrow_table WHERE id = :id";
                        ...
                        error_log("Error in viewborrow.php: " . $e->getMessage());
                   ...
                   <div class="row bg-light rounded"><!-- start row-->
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="" class="form-label">Registration No:</label>                                <input type="text" id="" class="form-control"  value="<?php echo htmlspecialchars($row['reg_no']); ?>"  disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="category" class="col-form-label">Category:</label>
                                <input type="text" id="category" class="form-control"  value="<?php echo htmlspecialchars($row['category']); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group shadow-sm">
                            <label for="category" class="col-form-label">Borrowed by:</label>
                                <input type="text" id="category" class="form-control" name="asset_cat" value="<?php echo htmlspecialchars($row['employee_name']); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <a href="../requestasset.php"><button class="btn btn-primary"><i class='fa fa-backward'></i></button></a>
                    </div>
